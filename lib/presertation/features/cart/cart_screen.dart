import 'package:app_sales/data/datasources/remote/api/cart_api.dart';
            ...
            listener: (context, state) {
              ...
              if (state.status == CartStatus.confirmSuccess) {
                ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text("Dat hang thanh cong")));
                      ...
                      Expanded(
                        child: ListView.builder(
                            ...
                            itemBuilder: (lstContext, index) => _buildItem(
                                state.cartModel!.items![index], context)),
                      ),
                      Container(
